...
contract BuybackBabyToken is IERC20Extended, Auth, BaseToken {
    ...
    constructor(
        ...
        distributor = new DividendDistributor(msg.sender, rewardToken_, router_);
    ...
    function _transferFrom(
        ...
        //This must be removed from the _transferFrom function, but due to you checking how much gas is left, you could leave this in,
        //but just be aware that it would cause buy/sell transactions to use a lot more gas.
